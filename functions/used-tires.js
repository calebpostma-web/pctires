// /functions/used-tires.js
// PC Tires — Used & Budget tire inventory.
// Public GET: returns available tires for the page.
// Owner POST (password-gated): verify / list / add / update / sold / delete.
//
// ONE-TIME SETUP in Cloudflare (Pages -> Settings):
//   1. KV: create a namespace named  PC_USED_TIRES
//   2. Functions -> KV namespace bindings: bind it as variable name  USED_KV
//   3. Environment variables: add  USED_PASSWORD  = <your owner password>
// Until those exist, GET returns empty and POST returns a clear error.
...
export async function onRequestPost(context) {
  ...
  if (!env.USED_KV) {
    return json({ ok: false, error: 'USED_KV namespace not bound. Create PC_USED_TIRES and bind it as USED_KV in Pages -> Settings -> Functions.' }, 500);
  }
